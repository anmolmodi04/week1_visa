...
@RunWith(SpringRunner.class) //Creates Spring container conducive for testing
@WebMvcTest(ProductController.class) //Searches only for @Controller and @RestController
public class ProductControllerTest {
	@MockBean
	private OrderService orderService;

	@Autowired
	private MockMvc mockMvc; // To call GET and POST
	...
	public void testGetProducts() throws Exception {
		...
		mockMvc.perform(get("/products"))
				...
				.andExpect(jsonPath("$", hasSize(2))) //To retrieve elements from json, use jsonPath
